...
# Configure Symetrie Hexapod Controller Driver (ControllerPort, LowLevelDriverPort, Address, Channels, MovingPollPeriod, IdlePollPeriod)
symetrieHexapod("HEXAPOD", "PPMAC_SSH", 0, 20, .05, 1)
